function vw = rmRunCueScriptGeneralMonotonic(vw,dataTypes, roi,wSearch,models, hrfParams, matFileName, maxCores, separateBetas, highestValue, blankValue, lowestValue)
...
if ~exist('maxCores','var') || isempty(maxCores)
    maxCores=8; % Grid fit only: make sure we turn of coarse to fine
end
