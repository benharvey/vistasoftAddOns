function vw = rmRunLogOccupancyFrequency2d(vw,dataTypes, roi,wSearch,models, hrfParams, matFileName, maxCores, separateBetas)
    ...
    for n=1:numel(models)
        switch lower(models{n})
            case '1g'
                ...
                matFileName = sprintf('retModel-%s-Log-2dCircGaussian-OccupancyPeriod-DT0.5-maxValue-%s',datestr(now,'yyyymmdd-HHMMSS'), num2str(highestValue,2)); 
