function vw = rmRunNumbersScriptLog(vw,dataTypes, roi,wSearch,models, hrfParams, matFileName, maxCores, separateBetas)
...
if ~exist('matFileName','var') || isempty(matFileName)
    if strcmp(models{1},'1g')
        matFileName = sprintf('retModel-%s-1DGaussian-Log-FullBlanks-DT0.5-Fine',models{1}, datestr(now,'yyyymmdd-HHMMSS')); 
