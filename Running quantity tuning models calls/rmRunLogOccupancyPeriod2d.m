function vw = rmRunLogOccupancyPeriod2d(vw,dataTypes, roi,wSearch,models, hrfParams, matFileName, maxCores, separateBetas, logIntensity)
    ...
    for n=1:numel(models)
        switch lower(models{n})
            case '1g'
                ...
                matFileName = sprintf('retModel-%s-Log-2dCircGaussian-OccupancyPeriod-DT0.5-maxValue-%s-logIntensity-%s',datestr(now,'yyyymmdd-HHMMSS'), num2str(highestValue,2), num2str(logIntensity,1)); 
