function [view,params] = rmHrfSearchFitPerVoxel(view,params)
...
switch desc,
    ...
    case {'double 2d prf fit (x,y,sigma,sigma2, center=positive)',...
         ...
         if exist('tmpii','var') && size(model{1}.beta, 3)<9
            beta=model{1}.beta;
...
outParams = hrfModelSearchFitPerVoxel(data,prediction,hrfParams,params);
