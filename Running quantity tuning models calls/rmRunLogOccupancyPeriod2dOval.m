function vw = rmRunLogOccupancyPeriod2dOval(vw,dataTypes, roi,wSearch,models, hrfParams, matFileName, maxCores, separateBetas, logIntensity)
    ...
    for n=1:numel(models)
        switch lower(models{n})
            case '1g'
                ...
                matFileName = sprintf('retModel-%s-Log-2dOvalGaussian-OccupancyPeriod-DT0.5-maxValue-%s-logIntensity-%s',datestr(now,'yyyymmdd-HHMMSS'), num2str(highestValue,2), num2str(logIntensity,1));  
                ...
                tmpv=rmMain([1 dataTypes(dt)],roi,wSearch,...
                    ...
                    'stimx', log([0.0238 0.05 0.0526 0.0556 0.0588 0.0625 0.0667 0.0714 0.0769 0.0833 0.0909 0.1 0.1111 0.1250 0.1429 0.15 0.1667 0.1765 0.2 0.2308 0.25 0.2857 0.3 0.3333 0.35 0.3750 0.4 0.4118 0.4286 0.4444 0.45 0.4737 0.5 0.5385 0.55 0.6 0.65 0.6667 0.7 0.75 0.8 0.8182 0.85 0.9 0.95 0.9524 1])+4,...
                    'stimy', log([0.05:0.05:1 2.1])+4);
        end
